var flag=0;$(".c-hamburger").on("click",function()
{if(!flag)
{$(".menu").show("slide",{direction:"left"},500);flag=1;$(".menu-text").show("slide",{direction:"right"},700).animate({fontSize:'2em'},"slow")}
else{$(".menu").hide("slide",{direction:"left"},500);flag=0}});(function()
{"use strict";var toggles=document.querySelectorAll(".c-hamburger");for(var i=toggles.length-1;i>=0;i--){var toggle=toggles[i];toggleHandler(toggle)};function toggleHandler(toggle){toggle.addEventListener("click",function(e){e.preventDefault();(this.classList.contains("is-active")===!0)?this.classList.remove("is-active"):this.classList.add("is-active")})}})();$(".scrollbtn").on('click',function(e){e.preventDefault();if(flag)
{$(".c-hamburger").click()}
var target=$(this).attr('href');$('html, body').delay(100).animate({scrollTop:($(target).offset().top)},800)});$(window).scroll("resize scroll",function()
{var homeBottom=$("#homeimg").height();var windowTop=$(window).scrollTop();windowTop=(windowTop);homeBottom=(0.5*homeBottom);if(homeBottom<windowTop)
{$(".scrollhome").hide()}
else{$(".scrollhome").show()}});$("#menu-half").on("click",function()
{if(flag)
{$(".c-hamburger").click()}});$(window).on("keydown",function(e)
{if(flag&&e.keyCode===27)
{$(".c-hamburger").click()}});$('input[type="checkbox"]').on('change',function(e){if(e.target.checked){$('#myModal_checkbox').modal()}});function detectmob(){if(navigator.userAgent.match(/Android/i)||navigator.userAgent.match(/webOS/i)||navigator.userAgent.match(/iPhone/i)||navigator.userAgent.match(/iPad/i)||navigator.userAgent.match(/iPod/i)||navigator.userAgent.match(/BlackBerry/i)||navigator.userAgent.match(/Windows Phone/i)){return!0}
else{return!1}}
...
{$(".modal-title").html("Rules for M�LOPACT�");$(".modal-body").html("<ul> \
...
</ul>");$(".popupbtn").click()});$("#event4").on("click",function()
{$(".modal-title").html("Rules for SQUADROP");$(".modal-body").html("<ul> \
...
</ul>");$(".popupbtn").click()});$("#event5").on("click",function()
{$(".modal-title").html("Rules for STOMP");$(".modal-body").html("<ul> \
...
</ul>");$(".popupbtn").click()});$("#event6").on("click",function()
{$(".modal-title").html("Rules for PASdeDEUX");$(".modal-body").html("<ul> \
...
</ul>");$(".popupbtn").click()});$("#event7").on("click",function()
{$(".modal-title").html("Rules for Light Camera Action");$(".modal-body").html("<ul> \
...
</ul>");$(".popupbtn").click()});$("#event8").on("click",function()
{$(".modal-title").html("Rules for MASK");$(".modal-body").html("<ul> \
  ...
  <li>No restriction on topic. However topics that are offensive to certain community, religion, gender etc are strictly prohibited and will lead to direct disqualification.</li> \
  <li>The script must be original</li> \
</ul>");$(".popupbtn").click()});$("#event9").on("click",function()
{$(".modal-title").html("Rules for STROKE");$(".modal-body").html("<ul> \
...
</ul>");$(".popupbtn").click()});$("#event10").on("click",function()
{$(".modal-title").html("Rules for Talento");$(".modal-body").html("All the necessary equipments will be provided. ");$(".popupbtn").click()});$("#event11").on("click",function()
{$(".modal-title").html("Rules for Online Events");$(".modal-body").html("<ul> \
...
</ul>");$(".popupbtn").click()});$(window).on("resize scroll",function()
{var windowTop=$(window).scrollTop();windowTop+=$("")
var eventOne=$("#event3").offset();var eventHeight=$("#event3").height();$(".testing1").html(eventHeight);$(".testing3").html(eventOne.top);$(".testing2").html(windowTop);var windowTopToFadeIn=(($("#event1").offset()).top)+$("#event1").height();if(windowTop>windowTopToFadeIn)
{alert("here");if(!eventOneAnimation)
{$("#event1").fadeIn(300);eventOneAnimation=1}}})